...
const firebaseConfig = {
  ...
  export { app,auth,query, storage, reference, uploadBytes,se, getDownloadURL ,onSnapshot,createUserWithEmailAndPassword, firestore, collection,database,updateProfile, getDocs, ref, set };