...
const firebaseConfig = {
  ...
  export { db,app,auth,query, storage, reference, uploadBytes,sendEmailVerification, getDownloadURL ,onSnapshot,createUserWithEmailAndPassword, firestore, collection,database,updateProfile, getDocs, ref, set };