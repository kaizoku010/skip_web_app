...
const firebaseConfig = {
  ...
  export { app,auth,query, storage, reference, uploadBytes, getDownloadURL ,onSnapshot,createUserWithEmailAndPassword, firestore, collection,database,updateProfile, getDocs, ref, set };