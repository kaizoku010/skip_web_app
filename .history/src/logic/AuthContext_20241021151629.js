...
const AuthProvider = ({ children }) => {
  ...
  // console.log("sent requests: ", user )


//  // Assuming 'events' is your array of event objects and each event has an 'attendees' array
// const all_attendees = events.flatMap((event) => 
//   event.attendees.filter((attendee) => attendee.attendeeId === user?.userId)
// );
