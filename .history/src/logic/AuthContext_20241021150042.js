...
const AuthProvider = ({ children }) => {
  ...
  const all_attendees = events.find((event) =>
    event.attendees.some((attendee) => attendee.attendeeId === user.userId)
  );

  console.log("all attendees on the event: ",all_attendees )
