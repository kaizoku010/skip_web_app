...
function EventHolder({ imageLink, eventName, date, desc, time }) {
  ...
  return (
    <div style={{backgroundImage:`url(${ima})`, backgroundSize:"contain"}} className="event-holder glassy">
      {/* {loading ? ( */}
      ...
      <div className="spacer">
        ...
        <div className="new-event-details2">
          ...
          <p className="event-desc-new newtext">{desc}</p>
