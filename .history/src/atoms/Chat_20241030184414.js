...
const Chat = () => {
  ...
  const shareContact = async () => {
    ...
    const contactMessage = `Hey there is my Contact Info, : ${contactInfo.username}, Email: ${contactInfo.userEmail}, Phone Number ${contactInfo.contact}`;
  ...
  return (
    <div className="chat-div">
            <Divider style={{marginTop:"-2rem"}}  orientation="left">Chat</Divider>
