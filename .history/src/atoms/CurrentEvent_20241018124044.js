...
//  console.log("Reciever Id: ", attendee.attendeeId, attendee.username, attendee.userImage)
...
<Space direction="vertical" align="center">
    ...
    <Modal
      ...
      >
        <p className="sa-userName">Name: {selectedAttendee?.username}</p>
        <p className="sa-userEmail" >Email: {selectedAttendee?.userEmail}</p>
        <p className="sa-userJob">Job: {selectedAttendee?.job}</p>
        <img className="as-userImage" src={selectedAttendee?.userImage}/>
