...
function EventDetails() {
  ...
  const eventdesc = "Our workshop is specially designed to give international job seekers in Sweden an insight into what is required by Swedish employers and how to improve their chances of success."
...
<p className='event-date-details'>10/10/2024</p>
<h1 className='ed-event-name'>WORLD HEART DAY</h1>
<p className='ed-evnt-desc'></p>
