        ...
        <div className='form-side'>
          <div className='form-side-holder'>
            ...
            <p className='sub-title'>
              Fill this form to get your e-ticket for {eve || "the event"}, the form automatically adds the event of choice to your profile, after filling the form, download our Events apps to proceed with your profile.
            </p>
            <MXForm
            price={eventPrice}
            eventName={eventName}
