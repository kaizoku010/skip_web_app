    ...
    <div className="header_">
      <div className="glass">
        ...
        <div className="event-details">
          ...
          Welcome to Moxie5 Events, Your Dynamic Partner For Corporate Events in Kampala, Uganda Solutions through innovative That Transcend Traditional Boundaries.{" "}
          </p>
