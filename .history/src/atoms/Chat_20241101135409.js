...
const Chat = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      await axios.post("https://skip-api-1gup.onrender.com/messageCount", {
...
//console.log("user events: ", userEvent_.eventId)
  ...
  const shareContact = async () => {
   ...
   // const contactInfo = getAttendeeInfo(contactEmail);
    ...
    try {
      ...
      await axios.post("https://skip-api-1gup.onrender.com/contactShareCount", {
        eventId: userEvent_.eventId,
        increment: 1,
      });
      playNotificationSound();
    } catch (error) {
