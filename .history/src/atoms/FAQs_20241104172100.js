...
function FAQs() {
  return (
    ...
    <Text className='faq-ans'>        To create an account, click on the Sign Up button on the home page, fill in your details, and follow the prompts. You’ll need a valid email address or can sign up using social media credentials.</Text>
    </Accordion.Panel>
