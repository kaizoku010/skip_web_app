...
import { VideoCameraAddFilled  } from "@ant-design/icons";
            ...
            <div className="story">
              ...
              <div className="make-post-actions">
                <div className="ic_post_area">
                  <VideoCameraAddOutlined className="icp_video"/>
                  <p className="icp_text">Video</p>
                </div>
                <div className="ic_post_area">
                  <FileImageOutlined className="icp_image"/>
                  <p className="icp_text">Image/Photo</p>
                </div>
                <div className="ic_post_area">
                  <FileAddOutlined className="icp_doc"/>
