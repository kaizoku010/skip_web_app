...
console.log("eventType: ", type)
  ...
  const config = {
    ...
    customizations: {
      title: "SK!P",
      description: `Paymnent ${eventName}`,
      logo: { Logo },
    },
  };
  ...
  //check if event type is not equal to paid hide the button this function is attached , 
  const openPayments = {
    ...config,
      ...
      {!success ? (
        ...
        <div className="confirmation-message">
          ...
          <p className="btn-zero">
            ...
            <Link>
                <button className="copy-pass">
              <FontAwesomeIcon icon={faCopy} /> Home
            </button>
            </Link>
