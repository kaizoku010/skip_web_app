          ...
          <div className="post_details">
            ...
            <div className="delete-options">
                  ...
                  {post.userId === user.userId && (
                    <button className="delete_btn" onClick={() => deletePostFunction(post.postId, eventId)}>Delete</button>
                    <Button className="delete_btn" onClick={() => deletePostFunction(post.postId, eventId) icon={<VideoCameraFilled />}>
