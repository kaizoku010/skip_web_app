...
<p className='ed-evnt-desc'>{"agenda here"}</p>
<p className='ed-evnt-desc'>{"speakers here"}</p>
<p className='ed-evnt-desc'>{"location here"}</p>
<img className='event' src={event?.eventImage}/>
