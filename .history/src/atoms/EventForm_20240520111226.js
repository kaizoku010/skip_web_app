        ...
        <div className='image-side'>
          <div style={{ backgroundImage: `url(${event?.eventGraphicsURL || testBg})` }} className='img-box'>
            ...
            <div className='selected-event glassy'>
              <p className='passed-data'>Event Name: <span className='passed-data2'>{event?.eventName || "Loading"}</span></p>
              <p className='passed-data'>Event Price:<span className='passed-data2'>{event?.eventPrice || "Loading"}</span></p>
              <p className='passed-data'>Event Location:<span className='passed-data2'></span> {event?.eventLocation || "Loading"}</p>
            </div>
          </div>
        </div>
      </div>
