  ...
  return (
    <div className="user_current_event2">
      ...
      <div className="event_found">
        ...
        <p className="aet_location noMargins"><span className="event-details-span">Time & Date : </span>{userEvent.eventDate | userEvent.eventTime}</p>
        <p className="aet_location noMargins"><span className="event-details-span">Location :</span>{userEvent.loc}</p>
