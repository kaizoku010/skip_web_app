...
function Login() {
  ...
  return (
    ...
    >
           {loading && (
                <div style={{ margin: "5%" }} className="progress-bar">
        ...
        <div className="login-holder flex-form">
          <div className="well">
            <form onSubmit={handleLogin} className="material-form">
              ...
              <p className="or">OR</p>
              <div style={{marginBottom:"5%"}} className="remember-me-group ">
                <Checkbox
                  defaultChecked
                  indeterminate 
                  checked={rememberMe}
                  onChange={(e) => setRememberMe(e.target.checked)}
                >
                  {"By continuing, you agree to Sk!p Events & Moxie 5 Marketing Agency’s Terms of Use and Privacy Policy."}
                </Checkbox>
              </div>
              <div
