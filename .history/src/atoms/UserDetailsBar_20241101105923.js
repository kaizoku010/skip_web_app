...
function UserDetailsBar() {
  ...
  console.log("people you may know filter: ", sameIndustryUsers)

  const sameIndustryUsers_ = sameIndustryUsers?.filter(
    user_ => user_.industry === user.industry && user_.userEmail !== user.email
  );

  console.log("people you may know filter: ", sameIndustryUsers_)
