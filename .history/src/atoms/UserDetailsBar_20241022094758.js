...
function UserDetailsBar() {
  ...
  const { user, sentChatRequests,all_attended, getMatchingAttendees, declineRequest,
      ...
      {selectedUser && (
        ...
        >
          <div className="modal-content">
            ...
            <p className="user-details-name"><strong>Email:</strong> {selectedUser.userEmail}</p>
            <p className="user-details-name"><strong>Job:</strong> {selectedUser.job}</p>
          </div>
        </Modal>
      )}
    </div>
