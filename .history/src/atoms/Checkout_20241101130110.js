...
{/* 
          ...
          <Payments eventName={eventName} price={eventPrice} customerName={user?.userName} customerContact={user?.contact} customerEmail={user?.userEmail} />
          <Link className="cancel-links" to="/">
            <Button ty>Back Home</Button>
          </Link>
        </form>
      )}
    </div>
