...
const Chat = () => {
  ...
  const getUnreadCount = (room) => {
    ...
    return totalMessages - lastReadCount;
  };
  ...
  return (
    ...
    >
      <Badge count={isNew ? unreadCount : 0} offset={[10, 0]}>
        <Avatar
          src={participantInfo.profilePic || TestImg}
          alt={participantInfo.userName}
        />
      </Badge>
...
<Avatar
src={
message.senderEmail === user.userEmail
? user.profilePic || TestImg
: getAttendeeInfo(message.senderEmail)?.profilePic ||
  TestImg
}
