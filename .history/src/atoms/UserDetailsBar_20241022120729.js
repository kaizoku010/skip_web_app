                      ...
                      <div key={request.id} className="current-user-section ibra" onClick={() => showUserDetails(request)}>
                        ...
                        <div className="cu-text">
                          ...
                          <div className="udb-actions">
                            <Button className="udb-btn udb-btn-approve" onClick={() => acceptRequest(request.requestId)}>
                              Approve
                            </Button>
                            <Button className="udb-btn udb-btn-decline" onClick={() => declineRequest(request.id)}>
                              Decline
                            </Button>
                          </div>
                        </div>
