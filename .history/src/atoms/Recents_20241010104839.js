  ...
  return (
    <div className="recents">
      <div className="recents_title">
        ...
        <Text type="secondary">In the process of internal desktop applications development, many different design specs and implementations would be involved</Text>
