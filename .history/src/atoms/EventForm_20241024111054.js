...
function EventForm() {
  ...
  return (
   ...
   <Link to={`${path}`} className='breadcrumb hideOnPc'>Home / Login</Link>
   <div className='Jq-area' style={{display:"flex",flexDirection:"column"}}>
    <Link to={`${path}`} className='breadcrumb hideOnMobile'>Home / Login</Link>
