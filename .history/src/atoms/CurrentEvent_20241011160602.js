  ...
  return (
    <div className="user_current_event2">
      ...
      <div className="event_found">
        ...
        <h4 className="active_event_title">{event.eventName}</h4>
        <p className="aet_location noMargins"><span className="event-details-span">Organizer :</span>{events.eventHost}</p>
        <p className="aet_location noMargins"><span className="event-details-span">Time & Date : </span>{events.eventDate}</p>
        <p className="aet_location noMargins"><span className="event-details-span">Location :</span>{event.loc}</p>
