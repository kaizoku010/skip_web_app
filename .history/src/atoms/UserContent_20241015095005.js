...
function UserContent({ user, events }) {
  ...
  const deletePostFunction =(postId, eventId, e)=>{
e.preventDefault()
      deletePost(postId, eventId)
      // console.log("passed options: ", postId, eventId)
          ...
          <div className="post_details">
            ...
            <div className="delete-options">
                  ...
                  {post.userId === user.userId && (
                    <button onClick={() => deletePostFunction(post.postId, eventId, e)}>Delete</button>
                  )}
                </div>
