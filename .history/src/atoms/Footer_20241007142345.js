...
<SlSocialYoutube/>
     ...
     <p>Sk!p Events is an events management platform and software owned by moxie 5 marketing agency LTD. By using this application, you accept and agree to Sk</p>
        </div>
      </div>
    </div>
  );
