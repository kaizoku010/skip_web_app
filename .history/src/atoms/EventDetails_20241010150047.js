...
<p className='ed-evnt-desc'><span className='eded-span'>Event Host: </span>{event?.eventHost}</p>
<p className='ed-evnt-desc'><span className='eded-span'>Event Host: </span>{event?.eventLocation}</p>
<p className='ed-evnt-desc'>{event?.eventType}</p>
<p className='ed-evnt-desc'>{event?.eventPrice}</p>
