...
function CurrentEvent({ user, events }) {
  ...
  // look up an attendee by email...we shall use this same code for the scan 
  ...
  console.log("attendeeInfo:", result)
      ...
      <div className="event_found">
        ...
        <div className="event_pass_holder">
          ...
          <Space direction="vertical" align="center">
            <QRCode
              value={`Attendee Id: ${result.attendeeId} Attendee Name: ${result.username}`}
            />
          </Space>
        </div>
      </div>
